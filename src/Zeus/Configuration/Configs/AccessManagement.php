...
/**
 * Access Management configuration controller
 *
...
class AccessManagement extends Configuration
{
     ...
     * @param  string  $slug
     */
    protected function accessUrlAccessManagement($slug) : void
    {
     ...
     */
    protected function loginErrorAccessManagement($message) : void
    {
     ...
     * @param  array   $args
     */
    protected function loginHeaderAccessManagement($args) : void
    {
        if (!$args) {
            return;
        }
        ...
        $configs = array_merge([
            'url'     => OL_ZEUS_HOME,
            'title'   => Translate::t('configuration.access.labels.title'),
        ], $args);
     ...
     * @param  bool    $shake
     */
    protected function loginShakeAccessManagement($shake) : void
    {
        if ($shake) {
            return;
        }
     ...
     * @param  array   $args
     */
    protected function loginStyleAccessManagement($args) : void
    {
        if (!$args) {
            return;
        }
