...
namespace GetOlympus\Zeus\Control\Controller;

use GetOlympus\Zeus\Base\Controller\BaseControl;
use GetOlympus\Zeus\Control\Exception\ControlException;
use GetOlympus\Zeus\Control\Implementation\ControlImplementation;
 ...
 * @subpackage Control\Controller
 * @author     Achraf Chouk <achrafchouk@gmail.com>
 * @since      2.0.2
 *
 */

abstract class Control extends BaseControl implements ControlImplementation
{
    /**
     * @var string
     */
     ...
     * @return array
     */
    abstract protected function getVars($value);
}
